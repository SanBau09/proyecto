...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(targetEntity: Incidencia::class, mappedBy: 'idUser', orphanRemoval: true)]
    ...
    public function removeIncidencia(Incidencia $incidencia): static
    {
        if ($this->incidencias->removeElement($incidencia)) {
            ...
            if ($incidencia->getIdUser() === $this) {
                $incidencia->setIdUser(null);
            }
        }
